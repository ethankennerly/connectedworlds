...
badd +1 triangle.ai
badd +46 line.ai
badd +88 src\com\finegamedesign\connectedworlds\Main.as
badd +172 src\com\finegamedesign\connectedworlds\Model.as
badd +203 src\com\finegamedesign\connectedworlds\View.as
...
badd +32 README.md
badd +66 src\com\finegamedesign\connectedworlds\Sounds.as
...
badd +1 corona.txt
badd +74 corona\DotDot\main.lua
...
badd +203 corona\DotDot\view.lua
...
badd +95 corona\DotDot\model.lua
...
badd +48 src\com\finegamedesign\connectedworlds\Prompt.as
badd +29 corona\DotDot\prompt.lua
badd +4 corona\DotDot\transitionSequence.lua
badd +22 corona\DotDot\sequence.lua
badd +25 corona\DotDot\loop.lua
args triangle.ai
edit corona.txt
...
exe 'vert 3resize ' . ((&columns * 65 + 65) / 130)
exe '4resize ' . ((&lines * 15 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 65 + 65) / 130)
exe '5resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 65 + 65) / 130)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 221 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
221
...
exe '5resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 65 + 65) / 130)
tabedit corona\DotDot\view.lua
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 1resize ' . ((&columns * 81 + 65) / 130)
exe '2resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 81 + 65) / 130)
exe '3resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 81 + 65) / 130)
exe '4resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 48 + 65) / 130)
exe '5resize ' . ((&lines * 15 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 48 + 65) / 130)
exe '6resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 6resize ' . ((&columns * 48 + 65) / 130)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 202 - ((9 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
202
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 267 - ((2 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
267
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((21 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 201 - ((11 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
201
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 175 - ((10 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 132 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
exe '4resize ' . ((&lines * 22 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 65 + 65) / 130)
tabedit C:\Program\ Files\ (x86)\Corona\ Labs\Corona\ SDK\Sample\ Code\Graphics\Easing_Examples\main.lua
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
