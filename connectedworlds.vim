...
badd +177 src\com\finegamedesign\connectedworlds\Model.as
...
badd +15 src\com\finegamedesign\connectedworlds\Trace.as
badd +1 corona.txt
...
badd +0 \Program\ Files\ (x86)\Corona\ Labs\Corona\ SDK\Sample\ Code\Graphics\Easing_Examples\main.lua
badd +5 corona\DotDot\trace.lua
badd +0 src\com\finegamedesign\connectedworlds\Prompt.as
badd +1 corona\DotDot\prompt.lua
badd +4 corona\DotDot\transitionSequence.lua
badd +22 corona\DotDot\sequence.lua
badd +7 corona\DotDot\loop.lua
args triangle.ai
edit corona.txt
...
exe '4resize ' . ((&lines * 17 + 23) / 46)
exe 'vert 4resize ' . ((&columns * 69 + 69) / 138)
exe '5resize ' . ((&lines * 5 + 23) / 46)
exe 'vert 5resize ' . ((&columns * 69 + 69) / 138)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((5 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 257 - ((19 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
257
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 401 - ((16 * winheight(0) + 8) / 17)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
401
...
exe 'vert 4resize ' . ((&columns * 68 + 69) / 138)
exe '5resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 5resize ' . ((&columns * 68 + 69) / 138)
exe '6resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 6resize ' . ((&columns * 68 + 69) / 138)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 193 - ((5 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
...
exe '6resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 6resize ' . ((&columns * 68 + 69) / 138)
tabedit C:\archive\flash\connectedworlds\src\com\finegamedesign\connectedworlds\Trace.as
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
exe 'vert 2resize ' . ((&columns * 68 + 69) / 138)
exe '3resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 3resize ' . ((&columns * 68 + 69) / 138)
exe '4resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 4resize ' . ((&columns * 69 + 69) / 138)
exe '5resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 5resize ' . ((&columns * 69 + 69) / 138)
exe '6resize ' . ((&lines * 14 + 23) / 46)
exe 'vert 6resize ' . ((&columns * 69 + 69) / 138)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
edit C:\archive\flash\connectedworlds\src\com\finegamedesign\connectedworlds\Trace.as
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 255 - ((4 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
255
