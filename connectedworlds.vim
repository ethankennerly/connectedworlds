...
badd +1 triangle.ai
badd +46 line.ai
badd +176 src\com\finegamedesign\connectedworlds\Main.as
...
badd +32 README.md
badd +78 src\com\finegamedesign\connectedworlds\Sounds.as
...
badd +88 corona\DotDot\model.lua
...
badd +1 corona\DotDot\prompt.lua
...
exe '1resize ' . ((&lines * 11 + 23) / 47)
exe 'vert 1resize ' . ((&columns * 57 + 68) / 137)
exe '2resize ' . ((&lines * 33 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 57 + 68) / 137)
exe '3resize ' . ((&lines * 13 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 79 + 68) / 137)
exe '4resize ' . ((&lines * 9 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 79 + 68) / 137)
exe '5resize ' . ((&lines * 21 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 79 + 68) / 137)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
exe 'vert 4resize ' . ((&columns * 68 + 68) / 137)
exe '5resize ' . ((&lines * 15 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 68 + 68) / 137)
exe '6resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 6resize ' . ((&columns * 68 + 68) / 137)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 140 - ((12 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
140
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 254 - ((9 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
254
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((4 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
exe '6resize ' . ((&lines * 14 + 23) / 47)
exe 'vert 6resize ' . ((&columns * 68 + 68) / 137)
tabedit C:\archive\flash\connectedworlds\src\com\finegamedesign\connectedworlds\Model.as
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 211 - ((4 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
211
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 237 - ((14 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
237
...
wincmd w
argglobal
edit C:\archive\flash\connectedworlds\src\com\finegamedesign\connectedworlds\Sounds.as
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
...
wincmd w
argglobal
edit C:\archive\flash\connectedworlds\src\com\finegamedesign\connectedworlds\Sonata.as
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 15 - ((0 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
