...
set shortmess=aoO
badd +9 connectedworlds.vim
badd +2 notes.txt
badd +432 connectedworlds.ai
badd +1 triangle.ai
badd +46 line.ai
badd +118 src\com\finegamedesign\connectedworlds\Main.as
badd +149 src\com\finegamedesign\connectedworlds\Model.as
badd +32 src\com\finegamedesign\connectedworlds\View.as
...
badd +1 src\com\finegamedesign\connectedworlds\Format.as
badd +1 README.md
...
badd +99 corona\DotDot\view.lua
...
badd +33 corona\DotDot\model.lua
...
exe 'vert 1resize ' . ((&columns * 68 + 63) / 126)
exe '2resize ' . ((&lines * 28 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 68 + 63) / 126)
exe '3resize ' . ((&lines * 10 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 57 + 63) / 126)
exe '4resize ' . ((&lines * 11 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 57 + 63) / 126)
exe '5resize ' . ((&lines * 22 + 23) / 47)
exe 'vert 5resize ' . ((&columns * 57 + 63) / 126)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((5 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 231 - ((0 * winheight(0) + 5) / 10)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
231
...
exe 'vert 2resize ' . ((&columns * 69 + 63) / 126)
exe '3resize ' . ((&lines * 15 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 19 + 63) / 126)
exe '4resize ' . ((&lines * 16 + 23) / 47)
exe 'vert 4resize ' . ((&columns * 19 + 63) / 126)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 148 - ((4 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
148
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 191 - ((0 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
191
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
